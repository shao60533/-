...
|------|------|------|---------|-------------|
| 2026-04-18 | [self-iterating-agents.md](self-iterating-agents.md) | v2.0 | 自我迭代 Agent 独立模块（美股版）：统一 qwen3.6-plus，四层 18 Agent Pipeline，Scorecard + Darwinian + Meta Agent prompt 进化。v2.0 改为独立于 TradingAgents 的完整系统 | — |
